...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  DateTime? selectedDate;
  String? selectedGender;
  bool showOtherGenderField = false;
  String? otherGender;
                      ...
                      child: Form(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            _buildGenderField(),
                            if (showOtherGenderField)
                              Padding(
                                padding: const EdgeInsets.only(top: 12),
                                child: TextFormField(
                                  onChanged: (val) => otherGender = val,
                                  decoration: InputDecoration(
                                    hintText: "Cinsiyetinizi belirtin",
  ...
  Widget _buildGenderField() {
    return DropdownButtonFormField<String>(
      ...
      items:
          ["Erkek", "Kadın", "Belirtmek İstemiyorum", "Diğer"].map((gender) {
            return DropdownMenuItem(value: gender, child: Text(gender));
          }).toList(),
      onChanged: (value) {
        setState(() {
          selectedGender = value;
          showOtherGenderField = value == "Diğer";
        });
      },
    );
  }
